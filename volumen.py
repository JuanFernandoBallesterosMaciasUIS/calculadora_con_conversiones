...
# Frame
    ...
    # fila 1
    boton7 = Button(menu, text = "7",command= lambda: click_boton(7),font = ("Bahnschrift Condensed",15))
    boton7.place(x=15, y=151, width = 73, height = 56)

    boton8 = Button(menu, text = "8", width = 9, height = 3,command= lambda: click_boton(8),font = ("Bahnschrift Condensed",15))
    boton8.place(x=102, y=151, width = 73, height = 56)

    boton9 = Button(menu, text = "9", width = 9, height = 3,command= lambda: click_boton(9),font = ("Bahnschrift Condensed",15))
    boton9.place(x=187, y=151, width = 73, height = 56)

    boton_borrar = Button(menu, text = "Borrar",command= lambda: borrar(),bg="slategray4", fg="black",font = ("Bahnschrift Condensed",15))
    boton_borrar.place(x=272, y=151, width = 73, height = 110) 

    # fila 2
    boton4 = Button(menu, text = "4", width = 9, height = 3,command= lambda: click_boton(4),font = ("Bahnschrift Condensed",15))
    boton4.place(x=15, y=217, width = 73, height = 56)

    boton5 = Button(menu, text = "5", width = 9, height = 3,command= lambda: click_boton(5),font = ("Bahnschrift Condensed",15))
    boton5.place(x=102, y=217, width = 73, height = 56)

    boton6 = Button(menu, text = "6", width = 9, height = 3,command= lambda: click_boton(6),font = ("Bahnschrift Condensed",15))
    boton6.place(x=187, y=217, width = 73, height = 56)

    # fila 3
    boton1 = Button(menu, text = "1", width = 9, height = 3,command= lambda: click_boton(1),font = ("Bahnschrift Condensed",15))
    boton1.place(x=15, y=281, width = 73, height = 56)

    boton2 = Button(menu, text = "2", width = 9, height = 3,command= lambda: click_boton(2),font = ("Bahnschrift Condensed",15))
    boton2.place(x=102, y=281, width = 73, height = 56)

    boton3 = Button(menu, text = "3", width = 9, height = 3,command= lambda: click_boton(3),font = ("Bahnschrift Condensed",15))
    boton3.place(x=187, y=281, width = 73, height = 56)

    boton_borrar = Button(menu, text = "Ejecutar", command=operar,bg="slategray4", fg="black",font = ("Bahnschrift Condensed",15))
    boton_borrar.place(x=272, y=281, width = 73, height = 110) 

    # fila 4

    boton0 = Button(menu, text = "0", width = 9, height = 3,command= lambda: click_boton(0),font = ("Bahnschrift Condensed",15))
    boton0.place(x=102, y=345, width = 73, height = 56)

    boton_punto = Button(menu, text = ".", width = 9, height = 3,command= lambda: click_boton("."),font = ("Bahnschrift Condensed",15))
    boton_punto.place(x=187,y=345, width = 73, height = 56)